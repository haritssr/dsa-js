...
function fibonacciClosedForm(position) {
  ...
  if (position < 1 || position > topMaxValidPosition) {
    throw new Error(`Can't handle position smaller than 1 or greate than ${topMaxValidPosition}`);
  }
...
console.log(fibonacciClosedForm(1));
console.log(fibonacciClosedForm(2));
console.log(fibonacciClosedForm(3));
console.log(fibonacciClosedForm(10));
